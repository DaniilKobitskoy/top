...
import com.fivegbet.fiveg.bets.esportedasrote.databinding.ActivityReffereeScoreTimerBinding

class ReffereeScoreTimer : AppCompatActivity() {
    ...
    lateinit var binding: ActivityReffereeScoreTimerBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityReffereeScoreTimerBinding.inflate(layoutInflater)
